...
for c = 1:3
    ...
    save([num2str(f) '/' 'fp_data' num2str(c)],'fp0_sel','varfp0_sel','B0_sel',...
        ...
        'n_genos0_sel','n_genosT_sel','n_genos0_all','n_genosT_all')
end